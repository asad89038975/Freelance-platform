...
if (isset($_GET['jobId']) && isset($_GET['userId'])) {
    ...
    $sql = "UPDATE apply_job SET candidate_status = 2 WHERE job_id = ? AND user_id = ?";
    ...
    $message ='
        <!DOCTYPE html>
            ...
            <head>
              ...
              <title>Work Rejected Notification!</title>
            </head>
            <body style="font-family: Arial, sans-serif; background-color: #000; color: #fff; padding: 20px;">
              ...
              <table style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                ...
                <tr>
                  <td align="center">
                    <h4 style="font-size: 34px; font-weight: 600; color: #0168ff;">Sorry for this time, Your work has been rejected!</h4>
    ...
    header("Location: appliedCandidate.php?status=2");
    exit();
} else {
