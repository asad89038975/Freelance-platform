                  ...
                  <form method="POST" action="adminLogin.php">
                    <div class="row d-flex align-items-center justify-content-center">
                      ...
                      <div class="form-outline mb-3 col-lg-12 col-md-12 col-12">
                        <input type="email" id="form3Example3cg" placeholder="Your Email" name="email" class="form-control form-control-lg" required />
                        <label class="form-label" for="form3Example3cg">Your Email</label>
                      </div>

                      <div class="form-outline mb-3 col-lg-12 col-md-12 col-12">
                        <input type="password" name="password" placeholder="Your Email" id="form3Example4cg" class="form-control form-control-lg" required />
